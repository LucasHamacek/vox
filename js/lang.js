const translations = {
  pt: {
    ...
    clientsTitle: "Alguns dos nossos clientes",
    clientGerdau: "Consultoria em BIM e planejamento de obras com foco em eficiência e precisão.",
    clientHead5: "Desenvolvimento de projetos BIM para empreendimentos comerciais e industriais.",
  ...
  en: {
    ...
    clientGerdau: "BIM consulting and construction planning focused on efficiency and accuracy.",
    clientHead5: "BIM project development for commercial and industrial ventures.",
    clientDraft: "Customized solutions in 3D modeling and project coordination.",
    clientTech: "Construction planning and management based on integrated BIM methodology.",
  ...
  es: {
    ...
    clientGerdau: "Consultoría BIM y planificación de obras enfocadas en eficiencia y precisión.",
    clientHead5: "Desarrollo de proyectos BIM para emprendimientos comerciales e industriales.",
    clientDraft: "Soluciones personalizadas en modelado 3D y compatibilización de proyectos.",
    clientTech: "Planificación y gestión de obras con metodología BIM integrada.",
